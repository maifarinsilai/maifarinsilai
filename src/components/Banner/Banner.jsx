          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0 lg:px-16">
                ...
                >
                  Let Mai Farinsilai Travel and Tour be your guide to breathtaking destinations, vibrant cultures, and unforgettable adventures. From hidden gems to iconic landmarks, we turn every journey into a story worth sharing.
                  <br />
                </p>
